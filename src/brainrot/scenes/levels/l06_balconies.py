...
LEVEL = Level("THE BALCONIES", "mesa", rise=8, gap=3.0, exit="ladder",
    ...
    ("balconies", [n("oak", arc=3.4, lift=1, hug=2.8, spread=2,
                     pedestal=False, moat=True),
                   n("terra_white", arc=3.2, lift=1, hug=3.6, form="wide",
                     kind="walk", pedestal=False, spread=0, ceiling=3,
                     orbs=1),
                   n("terra_yellow", arc=3.4, lift=2, hug=3.8,
                     pedestal=False, spread=1, ceiling=2),
                   n("terra_orange", arc=3.0, lift=3, hug=4.4,
                     pedestal=False, spread=1, deco="lamp", orbs=1),
                   n("terra_red", arc=4.9, lift=1, hug=3.0, pedestal=False,
                     spread=2, orbs=2)]),
    ...
    ("seep", [n("terra_white", arc=3.4, lift=1, hug=2.8, spread=1,
                moat=True, ceiling=2, orbs=1),
              n("terra_orange", arc=3.0, lift=1, hug=3.2, kind="walk",
    ...
    ("gallery", [n("terra_white", arc=3.4, lift=2, hug=2.6, spread=1,
                   pedestal=False, ceiling=3),
                 n("oak", arc=2.9, lift=2, hug=2.6, kind="walk", spread=0,
    ...
    ("ledgerun", [n("terra_orange", arc=3.4, lift=1, hug=2.8, spread=1,
                    ceiling=2),
                  n("terra_white", arc=3.4, lift=2, form="slab", hug=3.4,
                    pedestal=False, spread=1),
                  n("terra_yellow", arc=3.4, lift=2, hug=4.2,
