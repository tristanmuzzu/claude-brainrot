...
LEVELS: tuple[Level, ...] = (
    ...
    Level("THE GATEHOUSE", "plains", rise=5, gap=2.8, exit="stair",
        ...
        ("wall", [n("rock", arc=3.4, lift=1, spread=1),
    ...
    Level("MARKET STREET", "village", rise=6, gap=3.0, exit="ladder",
        ...
        ("street", [n("ground", arc=4.6, lift=0, form="floor", orbs=1),
                    n("rock", arc=3.4, lift=1, spread=1)]),
        ("stalls", [n("accent", arc=3.4, lift=2, spread=0, radial=1.3),
                    n("accent", arc=3.3, lift=2, spread=0, radial=-1.3,
                      orbs=1)]),
    ...
    Level("THE TIMBERWORKS", "mine", rise=5, gap=2.6, exit="ladder",
        ...
        ("props", [n("accent", arc=3.4, lift=1, spread=0, shell="tunnel"),
                   n("rock", arc=3.4, lift=2, spread=0, shell="tunnel",
                     orbs=1)]),
    ]),
    ...
    Level("THE BALCONIES", "mesa", rise=7, gap=3.4, exit="stair",
        ...
        ("bridge", [n("rock", arc=3.4, lift=1, hug=6.2, pedestal=False,
                      spread=0),
                    n("accent", arc=4.2, lift=1, form="slab", hug=6.6,
                      pedestal=False, spread=0, orbs=1),
                    n("accent", arc=3.4, lift=2, form="slab", hug=6.2,
                      pedestal=False, spread=0)]),
        ("landing", [n("rock", arc=4.6, lift=1, spread=1, orbs=1)]),
    ...
    Level("GLACIER SHELF", "ice", rise=4, gap=3.2, exit="stair",
        ...
        ("crevasse", [n("blueice", arc=4.8, lift=2, kind="slide", form="ice",
                        hug=6.0, pedestal=False, spread=0, orbs=1),
                      n("blueice", arc=4.6, lift=2, kind="slide", form="ice",
                        hug=6.4, pedestal=False, spread=0, orbs=1)]),
    ...
    Level("THE CRUCIBLE", "nether", rise=7, gap=3.2, exit="stair",
        ...
        ("vault", [n("rock", arc=3.3, lift=1, hug=3.0, spread=0,
                     shell="cave"),
    ...
    Level("THE SILENCE", "deepdark", rise=6, gap=3.4, exit="ladder",
        ...
        ("thread", [n("accent", arc=3.0, lift=3, spread=0, pedestal=False,
                    ...
                    n("accent", arc=3.4, lift=3, spread=0, pedestal=False,
                      radial=-1.6, orbs=1)]),
        ("gulf", [n("rock", arc=6.0, lift=1, spread=0, pedestal=False,
                    hug=6.0, orbs=2)]),
    ...
    Level("THE VAULT", "gold", rise=5, gap=2.8, exit="stair",
        ...
        ("strongroom", [n("rock", arc=3.3, lift=1, hug=3.0, spread=0,
                          shell="cave"),
                        n("gold", arc=3.4, lift=2, hug=3.0, spread=0,
                          shell="cave", orbs=1),
                        n("rock", arc=3.3, lift=2, hug=3.0, spread=0,
                          shell="cave")]),
    ...
    Level("ROPE BRIDGE", "jungle", rise=5, gap=3.4, exit="vine",
        ...
        ("post", [n("rock", arc=3.4, lift=2, spread=0, hug=6.0,
                    pedestal=False, orbs=1)]),
        ("planks", [n("oak", arc=3.2, lift=2, spread=0, hug=6.6,
                      pedestal=False),
                    n("oak", arc=3.2, lift=1, spread=0, hug=6.8,
                      pedestal=False, orbs=1),
                    n("oak", arc=3.2, lift=1, spread=0, hug=6.8,
                      pedestal=False),
                    n("oak", arc=3.3, lift=2, spread=0, hug=6.6,
                      pedestal=False, orbs=1)]),
        ("span", [n("oak", arc=4.6, lift=2, spread=0, hug=6.2,
                    pedestal=False, orbs=2)]),
    ...
    Level("THE PILLARS", "end", rise=6, gap=3.4, exit="bubble",
        ...
        ("pillars", [n("accent", arc=3.4, lift=3, spread=0, hug=6.0,
                       pedestal=False),
                     n("accent", arc=3.3, lift=4, spread=0, hug=6.4,
                       pedestal=False, orbs=1),
                     n("accent", arc=3.4, lift=5, spread=0, hug=6.0,
                       pedestal=False)]),
    ...
    Level("SPORE HOLLOW", "mushroom", rise=5, gap=3.0, exit="vine",
        ...
        ("litter", [n("ground", arc=4.4, lift=0, form="floor", orbs=1),
                    n("rock", arc=3.4, lift=1, spread=1)]),
        ("hollow", [n("rock", arc=3.3, lift=1, hug=3.0, spread=0,
                      shell="cave"),
                    n("rock", arc=3.4, lift=2, hug=3.0, spread=0,
                      shell="cave", orbs=1)]),
    ...
    Level("DUST DEVILS", "mesa", rise=7, gap=3.6, exit="stair",
        ...
        ("caps", [n("accent", arc=3.4, lift=1, spread=0, radial=1.4),
                  n("rock", arc=3.3, lift=2, spread=0, radial=-1.4,
                    orbs=1)]),
        ("mesa", [n("accent", arc=4.6, lift=1, spread=1, hug=5.0,
                    pedestal=False, orbs=1)]),
    ...
    Level("THE CORNICE", "snow", rise=5, gap=3.0, exit="stair",
        ...
        ("cornice", [n("rock", arc=3.4, lift=1, spread=0, hug=6.2,
                       pedestal=False),
                     n("rock", arc=3.3, lift=2, spread=0, hug=6.4,
                       pedestal=False, orbs=1)]),
        ("posts", [n("accent", arc=3.5, lift=1, spread=0, radial=1.2),
                   n("accent", arc=3.4, lift=2, spread=0, radial=-1.2,
                     orbs=1)]),
    ]),
